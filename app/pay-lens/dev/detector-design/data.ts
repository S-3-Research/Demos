...
export const STATES_DATA = [
  ...
  { code: 'CHECKOUT_PAYMENT_STEP', desc: { en: 'Checkout URL + payment options visible', zh: '结账 URL + 支付选项可见' }, terminal: { en: '✅ Terminal (success)', zh: '✅ 终止成功' }, cls: 'success' },
...
export const OUTPUT_FILES = [
  { icon: '📋', name: 'result-summary.json', desc: { en: 'All DetectedEntity + metadata', zh: '所有 DetectedEntity + 元数据' }, detail: { en: 'Contains each detected gateway entity, all signals, confidence, availability and unavailableReason.', zh: '包含每个检测到的网关实体、所有信号、置信度、可用性及 unavailableReason。' } },
